...
<?php if (! ow_are_we_whitelabeled()): ?>
	<br/>
	<br/>
	<img src="<?php echo ow_branding('logo'); ?>" alt="logo" class='ow-logo ow-logo-side' width="500px" style='margin:auto;display:block'>
<?php endif; ?>
