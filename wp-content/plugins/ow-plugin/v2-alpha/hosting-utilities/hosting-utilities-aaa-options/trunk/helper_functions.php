...
function hu_branding($modifier='default', $default=false){
	...
	switch($modifier){
		...
		case 'phone':
			return $info['phone'] ?? $default;
		case 'ticketing email':
			return $info['ticketing_email'] ?? $default;
		case 'company':
		case 'default':
		default:
...
/* This is so other plugins can know if they need to include the helper functions, or if they where already included */
const HU_HELPER_FUNCTIONS_LOADED = true;
