...
function ow_announcement_branding_ajax_callback() {
  ...
  if (defined('HU_PRO_VERSION')){
	  $default_branding_info = array(
		...
		$default_branding_info = array(
  	   	...
  	   	'url' => 'https://hostingutilities.com/',
  	   	'url_pricing' => 'https://hostingutilities.com/',
  	   	'logo' => 'http://hostingutilities.net/uploads/hu-logo-embossed.png',
  	   	'menu-icon' => 'https://wordpressoverwatch.com/logo.svg',
  	   	'possessive' => "Hosting Utilities",
  	   	'official' => 'WP Overwatch LLC',
  ...
  $branding = $default_branding_info;
