...
/* theme updates */
if ( ! empty($hu_settings['auto_update_themes']) ){
  add_filter( 'auto_update_theme', '__return_true' );
}

/* core updates */
if ( ! empty($hu_settings['auto_update_core']) ){
  add_filter( 'auto_update_core', '__return_true' );
}

/* plugin updates */
if ( ! empty($hu_settings['auto_update_plugins']) ){
	if ( ! empty($hu_settings['exclude_plugin_updates']) ){
	  ...
	  function exclude_plugins_from_auto_updating( $update, $item ) {
	      ...
	      $exclude = explode(',', $hu_settings['exclude_plugin_updates']);
