...
// define the woocommerce_is_purchasable callback
function wpr_gift_card_is_purchasable( $is_purchasable, $post ) {
	$is_custom = get_post_meta( $post->get_id(), '_wpr_cp', true );
	$is_giftcard = get_post_meta( $post->get_id(), '_giftcard', true );
...
add_filter( 'woocommerce_is_purchasable', 'wpr_gift_card_is_purchasable', 10, 2 );
