...
<div class="sponsors-page-container">
    ...
    <section class="title-section">
        ...
        <p class="text-section">There are a number of ways to support the SCERA Theatre. Sponsorship opportunities are available in a variety of areas:</p>

        <p class="text-section">All Sponsorship levels can be custom designed to provide the sponsor with the benefits and return on investment that meet their particular goals and needs.</p>
    ...
    <section class="sponsors-section">
		...
		<div class="sponsor-images">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/img/national-endowment-sponsor.png" alt="">
		</div>
    </section>
