					...
					<div class="cast-list-wrapper">
						<div class="cast-wrap cast-list">
							...
							<div class="cast-content-wrap">
								<h2><?php the_title(); ?></h2>
								<div class="cast-content entry-content"><?php global $post; echo apply_filters( 'the_content', $post->post_content ); /* hackish solution for fixing the_content() not working */ ?></div>
							</div>
